...
- `reverse_toolkit` for common local RE stacks such as radare2/rizin, JADX,
  apktool, binwalk, YARA, Ghidra headless, gdb/lldb, Frida inventory, and
  Unicorn/unidbg harness templates.
